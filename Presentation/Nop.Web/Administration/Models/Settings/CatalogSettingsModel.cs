...
namespace Nop.Admin.Models.Settings
{
    public partial class CatalogSettingsModel : BaseNopModel
    {
        ...
        [NopResourceDisplayName("Admin.Configuration.Settings.Catalog.CategoryShowInLeftMenu")]
        public bool CategoryShowInLeftMenu { get; set; }
        public bool CategoryShowInLeftMenu_OverrideForStore { get; set; }

        [NopResourceDisplayName("Admin.Configuration.Settings.Catalog.ShowCategoriesTopMenu")]
        public bool ShowCategoriesTopMenu { get; set; }
        public bool ShowCategoriesTopMenu_OverrideForStore { get; set; }

        [NopResourceDisplayName("Admin.Configuration.Settings.Catalog.ShowVendorsTopMenu")]
        public bool ShowVendorsTopMenu { get; set; }
        public bool ShowVendorsTopMenu_OverrideForStore { get; set; }

        [NopResourceDisplayName("Admin.Configuration.Settings.Catalog.ShowManufacturersTopMenu")]
        public bool ShowManufacturersTopMenu { get; set; }
        public bool ShowManufacturersTopMenu_OverrideForStore { get; set; }
