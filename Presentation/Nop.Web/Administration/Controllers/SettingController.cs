...
namespace Nop.Admin.Controllers
{
    public partial class SettingController : BaseAdminController
	{
        ...
        public ActionResult Catalog(CatalogSettingsModel model)
        {
            ...
            if (model.CategoryShowInLeftMenu_OverrideForStore || storeScope == 0)
                _settingService.SaveSetting(catalogSettings, x => x.CategoryShowInLeftMenu, storeScope, false);
            else if (storeScope > 0)
                _settingService.DeleteSetting(catalogSettings, x => x.CategoryShowInLeftMenu, storeScope);

            if (model.ShowCategoriesTopMenu_OverrideForStore || storeScope == 0)
                _settingService.SaveSetting(catalogSettings, x => x.ShowCategoriesTopMenu, storeScope, false);
            else if (storeScope > 0)
                _settingService.DeleteSetting(catalogSettings, x => x.ShowCategoriesTopMenu, storeScope);

            if (model.ShowManufacturersTopMenu_OverrideForStore || storeScope == 0)
                _settingService.SaveSetting(catalogSettings, x => x.ShowManufacturersTopMenu, storeScope, false);
            else if (storeScope > 0)
                _settingService.DeleteSetting(catalogSettings, x => x.ShowManufacturersTopMenu, storeScope);

            if (model.ShowVendorsTopMenu_OverrideForStore || storeScope == 0)
                _settingService.SaveSetting(catalogSettings, x => x.ShowVendorsTopMenu, storeScope, false);
            else if (storeScope > 0)
                _settingService.DeleteSetting(catalogSettings, x => x.ShowVendorsTopMenu, storeScope);
